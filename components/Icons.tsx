...
export const IconSortAlpha = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m11 5-5-5-5 5"/><path d="M6 0v12"/><path d="M14 3h7"/><path d="M14 8h7"/><path d="M14 13h7"/></svg>
);

export const IconDrag = ({ className }: { className?: string }) => (
