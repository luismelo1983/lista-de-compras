    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-3">
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-xl p-6 border border-slate-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {mode === 'REGISTER' && (
            <div>
              <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1" htmlFor="name">Nome</label>
              <input 
                id="name"
                name="name"
                type="text" 
          ...
          <div>
            <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1" htmlFor="email">Email</label>
            <input 
              id="email"
              name="email"
              type="email" 
          ...
          {mode !== 'FORGOT_PASSWORD' && (
            <div>
               <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1" htmlFor="password">Senha</label>
               <div className="relative">
                 <input 
                  ...
                  className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 outline-none transition-all pr-10"
                  placeholder="••••••••"
                  required
